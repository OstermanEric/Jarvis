...
GPT_model = "gpt-3.5-turbo" # most capable GPT model and optimized for chat.  You can substitute with gpt-3.5-turbo for lower cost and latency.
...
chat_log=[
    {"role": "system", "content": "Your name is Computer. You are a helpful assistant. If asked about yourself, you include your name in your response."},
    ]
...
def wake_word():
    ...
    porcupine = pvporcupine.create(keywords=keywords,
                            ...
                            sensitivities=[1.0, 1.0,], #from 0 to 1.0 - a higher number reduces the miss rate at the cost of increased false alarms
                                   )
